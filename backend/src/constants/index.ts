...
export const INTERNAL_ERROR_TEXT = "Something went wrong on our side! See here: ";
export const NOT_FOUND_TEXT = "Resource could not be found.";
export const BAD_OBJECTID_PARSE_TEXT = "ObjectID argument passed in [the query] must be a single String of 12 bytes or a string of 24 hex";
/**
